  ...
  const alerts: Alert[] = [
    {
      ...
      confidence: 0.94,
      description:
        "Category 4 Cyclone approaching North Coast. Immediate evacuation recommended.",
      affectedPopulation: 450000,
      recommendedActions: [
        "Evacuate to higher ground",
        "Secure loose objects",
        "Stockpile 3 days of water",
      ],
      status: "Active",
      lat: 45.523062,
      lng: -122.676482,
    },
    {
      ...
      confidence: 0.88,
      description:
        "Heavy rainfall causing rapid river level rise in Central Valley.",
    ...
    },
    {
      ...
      confidence: 0.72,
      description:
        "Minor tremors detected. Potential for larger event within 24 hours.",
...
export const getSystemHealth: RequestHandler = (req, res) => {
  const health: SystemHealth = {
    models: [
      {
        name: "Cyclone Predictor",
        status: "online",
        version: "v2.4.1",
        latency: 45,
      },
      {
        name: "Flood Forecaster",
        status: "online",
        version: "v1.8.0",
        latency: 32,
      },
    ...
    recentLogs: [
      {
        ...
        timestamp: new Date().toISOString(),
        level: "info",
        message: "Model retraining completed for Cyclone Predictor.",
      },
      {
        id: "2",
        timestamp: new Date(Date.now() - 60000).toISOString(),
        level: "warn",
        message: "Sensor #402 reporting intermittent connectivity.",
      },
      {
        id: "3",
        timestamp: new Date(Date.now() - 120000).toISOString(),
        level: "error",
        message: "Failed to ingest satellite imagery from ESA source.",
      },
    ],
  };
  res.json(health);
