      ...
      <div className="flex-1 relative z-0">
                  ...
                  <button
                    onClick={() =>
                      setActiveLayers((prev) => ({
                        ...prev,
                        [layer.id]: !prev[layer.id as keyof typeof prev],
                      }))
                    }
                    className={cn(
        ...
        <div className="absolute bottom-6 left-6 z-[1000]">
          <Card className="bg-card/90 backdrop-blur border-border rounded-xl p-4 shadow-2xl w-64">
            <h4 className="text-xs font-bold mb-3 uppercase tracking-wider opacity-70">
              Risk Legend
            </h4>
            ...
            <div className="p-6 border-b border-border flex justify-between items-center">
              <div>
                <Badge
                  className={cn(
                    "mb-2",
                    selectedRegion.severity === "Emergency"
                      ? "bg-emergency/20 text-emergency border-emergency/50"
                      : selectedRegion.severity === "Warning"
                ...
                <section className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-secondary/30 p-3 rounded-lg border border-border/50">
                      ...
                      <div className="flex items-center gap-2">
                        {selectedRegion.type === "Cyclone" ? (
                          <Wind className="h-4 w-4" />
                        ) : selectedRegion.type === "Flash Flood" ? (
                  ...
                  <div className="flex items-center gap-4 p-4 bg-primary/5 rounded-xl border border-primary/20">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold">
                        {selectedRegion.affectedPopulation.toLocaleString()}
                      </p>
                    </div>
                  </div>
                </section>
