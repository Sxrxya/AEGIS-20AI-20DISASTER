      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Real-time monitoring of ML pipelines and infrastructure.
          </p>
        </div>
        <div className="flex items-center gap-4">
          ...
          <Badge
            variant="outline"
            className="bg-safe/10 text-safe border-safe/50 gap-1.5 py-1 px-3"
          >
        ...
        <Card className="bg-card/50 border-border">
          <CardContent className="pt-6">
            ...
            <h3 className="text-2xl font-bold mt-1">
              {health?.ingestion.rate.toLocaleString()}{" "}
        ...
        <Card className="bg-card/50 border-border">
          <CardContent className="pt-6">
            <div className="flex justify-between items-start mb-4">
              ...
              <Badge variant="secondary" className="text-[10px]">
                {health?.sensors.active}/{health?.sensors.total}
              </Badge>
            </div>
            <p className="text-sm font-medium text-muted-foreground">
              Sensor Network
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 bg-card/50 border-border">
          <CardHeader>
            ...
            <CardDescription>
              Status and performance of active prediction models.
            </CardDescription>
          </CardHeader>
          <CardContent>
